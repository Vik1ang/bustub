...
namespace bustub {
/**
 * StringUtil provides INEFFICIENT utility functions for working with strings. They should only
...
class StringUtil {
 public:
  ...
  /**
   * @return true if target string starts with the given suffix, false otherwise
   */
  static auto StartWith(const std::string &str, const std::string &prefix) -> bool;
  ...
  /**
   * @return lower version of the string
   */
